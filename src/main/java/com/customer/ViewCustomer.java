...
public class ViewCustomer extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.println("<tr><td colspan=4><h2 style=text-align:center>Customer Details</h2></td></tr>");
		pw.println("<th>Customer_ID</th><th>Customer_name</th><th>location</th><th>phone No.</th>");
		try {
