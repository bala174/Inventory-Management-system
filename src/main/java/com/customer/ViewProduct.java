...
public class ViewProduct extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.println("<tr><td colspan=5><h2 style=text-align:center>Product Details</h2></td></tr>");
		pw.println("<th>Product_ID</th><th>product_code</th><th>product_name</th><th>costPrice</th><th>sellPrice</th>");
		try {
